        ...
        return {
            ...
            authenticateUser: function (apiDomain, userId, userCode) {
                return $http.get(apiDomain + '/api/config/usuarios', {
                    ...
                    try {
                        var users = JSON.parse(atob(response.data.USR));
                        var user = users.find(function (u) { return u.id === userId && u.code === userCode; });
...
//# sourceMappingURL=cdi-widget.service.js.map